   ...
   $(function() {
    'use strict';
  	...
  	if ('<?php echo html_entity_decode($active_language) ?>' == 'vietnamese') {
       $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/hr_control/uploads/sample_file/Sample_import_job_position_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('hr_download_sample') ?></a><hr>' );

     } else {
       $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/hr_control/uploads/sample_file/Sample_import_job_position_file_en.xlsx" class="btn btn-primary" ><?php echo _l('hr_download_sample') ?></a><hr>' );
     }
