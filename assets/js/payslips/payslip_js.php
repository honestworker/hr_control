<script >
	(function() {
		...
		var url_manage = admin_url + 'hr_control/payslip_manage';
		var options = {
	...
	$(".luckysheet_info_detail_save").off('click').on('click', function(e) {   
    	...
    	formData.append("csrf_token_name", $('input[name="csrf_token_name"]').val());
			...
			$.ajax({
				url: admin_url + 'hr_control/view_payslip_detail',
				type: 'POST',
				data: formData,
				contentType: false,
	...
	$(".luckysheet_info_detail_payslip_close").off('click').on('click', function(e) {   
    	...
    	//show box loading
			...
			$.ajax({
				url: admin_url + 'hr_control/payslip_closing',
				type: 'POST',
				data: formData,
				contentType: false,
				success: function (response, status, xhr) {
...
$(".luckysheet_info_detail_exports").off('click').on('click', function(e) {   
		...
		$.ajax({ 
			url: admin_url + 'hr_control/create_payslip_file', 
			method: 'post', 
			data: formData, 
			contentType: false, 
			processData: false
