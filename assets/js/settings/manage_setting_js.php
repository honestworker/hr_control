<script>
  ...
  initDataTable(table_procedure_retire,admin_url + 'hr_control/table_procedure_retire');
  ...
  {
    $( "#dowload_file_sample" ).append('<a href="<?php echo base_url('modules/hr_control/uploads/Sample_import_province_vi.xlsx'); ?>" class="btn btn-success" ><?php echo _l('hr_download_sample') ?></a><hr>' );
  } else {
    $( "#dowload_file_sample" ).append( '<a href="<?php echo base_url('modules/hr_control/uploads/Sample_import_province_en.xlsx'); ?>" class="btn btn-success" ><?php echo _l('hr_download_sample') ?></a><hr>' );
  }
