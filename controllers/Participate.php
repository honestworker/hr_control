    ...
    public function index($id, $hash)
    {
        ...
        if ($this->input->post()) {
            ...
            if ($success) {
                ...
                redirect(hooks()->apply_filters('survey_default_redirect', site_url('hr_control/' . $id . '/' . $hash . '?participated=yes')));
            }
        }
        $this->app_css->theme('surveys-css', module_dir_url('hr_control', 'assets/css/training/training_post.css'));
        $this->disableNavigation()->disableSubMenu();
