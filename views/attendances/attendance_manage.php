			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open(admin_url('hr_control/add_attendance'),array('id'=>'add_attendance')); ?>
						<div class="col-md-12">
							<small><?php echo _l('handsontable_scroll_horizontally') ?></small>
						</div>
						<div id="total_insurance_histtory" class="col-md-12">
							<div class="row">
								<div class="hot handsontable htColumnHeaders" id="hr_employees_value">
								</div>
								<?php echo form_hidden('hr_attendance_value'); ?>
								...
								<?php echo form_hidden('hr_attendance_rel_type'); ?>
							</div>
						</div>

						<div class="col-md-12">
							<div class="modal-footer">
								<?php if(has_permission('hr_attendance', '', 'create') || has_permission('hr_attendance', '', 'edit')) { ?>
									...
									<?php if(hr_get_timesheets_status() == 'hr_timesheets') { ?>
										<button type="button" class="btn btn-info pull-right save_synchronized mleft5 " onclick="save_synchronized(this); return false;" title="<?php echo _l('synchronized_timesheet_title'); ?>"><?php echo _l('hr_synchronized'); ?> <i class="fa fa-question-circle i_tooltip" data-toggle="tooltip" title="" data-original-title="<?php echo _l('synchronized_timesheet_title'); ?>"></i></button>
									<?php } ?>
									...
									<a href="<?php echo admin_url('hr_control/import_xlsx_attendance'); ?>" class=" btn mright5 btn-default pull-right">
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/attendances/attendance_manage_js.php'; ?>
