						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">									
									<a href="<?php echo admin_url('hr_control/manage_attendance'); ?>" class=" btn  btn-default ">
										<?php echo _l('hr_back'); ?>
									</a>
...
<?php init_tail(); ?>
<?php require('modules/hr_control/assets/js/attendances/import_attendance_js.php'); ?>
</body>
</html>
