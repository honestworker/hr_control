			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open(admin_url('hr_control/add_manage_commissions'),array('id'=>'add_manage_commissions')); ?>
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/commissions/commissions_manage_js.php'; ?>
