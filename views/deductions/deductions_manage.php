			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open(admin_url('hr_control/add_manage_deductions'),array('id'=>'add_manage_deductions')); ?>
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/deductions/deductions_manage_js.php'; ?>
