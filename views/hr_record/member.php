				...
				<div class="col-md-3">
					...
					<ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
						...
						foreach($tab as $group_item) {
							...
							<a href="<?php echo admin_url('hr_control/member/'.$staffid.'/'.$group_item); ?>" data-group="<?php echo html_entity_decode($group_item); ?>">
								<?php
...
<?php 
if ($group == 'contract') {
	require('modules/hr_control/assets/js/hr_record/includes/contract_js.php');
}
if ($group == 'training') {
	require('modules/hr_control/assets/js/hr_record/includes/training_js.php');
}
if ($group == 'notification') {
	require('modules/hr_control/assets/js/hr_record/includes/notifications_js.php');
}
?>
<?php 
