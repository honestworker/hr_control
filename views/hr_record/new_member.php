...
<div id="wrapper" >
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open_multipart(admin_url('hr_control/add_edit_member'), array('id' => 'add_edit_member')); ?>
						<div class="modal-body">
									...
									<div class="col-md-12">  
										<div class="picture-container pull-left">
											<div class="picture pull-left">
												<img src="<?php if (isset($staff_cover_image) && isset($image_exist) && isset($link_cover_image)) { echo  base_url($link_cover_image); } else {  echo site_url(HR_CONTROL_PATH.'none_avatar.jpg'); } ?>" class="picture-src" id="wizardPicturePreview" title="">
							...
							<div class="modal-footer">
								<a href="<?php echo admin_url('hr_control/staff_infor'); ?>"  class="btn btn-default mr-2 "><?php echo _l('hr_close'); ?></a>
	...
	require('modules/hr_control/assets/js/hr_record/add_staff_js.php');
	?>
</body>
</html>