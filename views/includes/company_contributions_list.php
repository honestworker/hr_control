...
<div>
	<?php echo form_open_multipart(admin_url('hr_control/setting_company_contributions_list'), array('id'=>'add_company_contributions_list')); ?>
	...
	<hr class="hr-color">
	<div class="form"> 
		<div id="company_contributions_list_hs" class="hot handsontable htColumnHeaders"></div>
