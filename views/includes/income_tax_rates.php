...
<div>
	<?php echo form_open_multipart(admin_url('hr_control/setting_incometax_rates'), array('id'=>'add_incometax_rates')); ?>
	...
	<hr class="hr-color">
	<div class="form"> 
		<div id="incometax_rate_hs" class="hot handsontable htColumnHeaders"></div>
