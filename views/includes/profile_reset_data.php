...
<?php echo form_open_multipart(admin_url('hr_control/profile_reset_data'), array('id'=>'reset_data')); ?>
<div class="_buttons">
    <?php if (is_admin()) { ?>
        <div class="row">
            <div class="col-md-12">
...
<?php require 'modules/hr_control/assets/js/settings/reset_data_js.php';?>
</body>
</html>
