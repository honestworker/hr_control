...
<div>
	<?php echo form_open_multipart(admin_url('hr_control/setting_salary_deductions_list'), array('id'=>'add_salary_deductions_list')); ?>
	...
	<hr class="hr-color">
	<div class="form"> 
		<div id="salary_deductions_list_hs" class="hot handsontable htColumnHeaders"></div>
