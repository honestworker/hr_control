			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open(admin_url('hr_control/add_manage_insurances'),array('id'=>'add_manage_insurances')); ?>
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/insurances/insurances_manage_js.php'; ?>
