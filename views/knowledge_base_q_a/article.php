  ...
  <div class="row">
   <div class="col-md-8 col-md-offset-2">
     ...
     <div class="panel-body">
      <h4 class="no-margin">
       ...
       <small>
        ...
        <a href="<?php echo admin_url('hr_control/knowledge_base_q_a/view/'.$article->slug); ?>" target="_blank"><?php echo admin_url('hr_control/knowledge_base_q_a/view/'.$article->slug); ?></a>
        <?php } else { ?>
    ...
    <p>
     ...
     <a href="<?php echo admin_url('hr_control/knowledge_base_q_a/article'); ?>" class="btn btn-success pull-right"><?php echo _l('kb_article_new_article'); ?></a>
     <?php } ?>
     <?php if (has_permission('hr_manage_q_a','','delete')) { ?>
     <a href="<?php echo admin_url('hr_control/knowledge_base_q_a/delete_article/'.$article->articleid); ?>" class="btn btn-danger _delete pull-right mright5"><?php echo _l('delete'); ?></a>
     <?php } ?>
...
<?php init_tail(); ?>
<?php  require('modules/hr_control/assets/js/knowledge_base_q_a/article_js.php'); ?>
