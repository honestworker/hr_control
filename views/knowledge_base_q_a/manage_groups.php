                    ...
                    <div class="panel-body">
                       <div class="_buttons">
                        ...
                        <div class="_buttons">
                            ...
                            <?php } ?>
                            <a href="<?php echo admin_url('hr_control/knowledge_base_q_a'); ?>" class="btn btn-info pull-left display-block mleft5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo admin_url('hr_control/knowledge_base_q_a/delete_group/'.$group['groupid']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php } ?>
...
<?php $this->load->view('hr_control/knowledge_base_q_a/group'); ?>
<?php init_tail(); ?>
</body>
</html>
