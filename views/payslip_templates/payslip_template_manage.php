			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12 ">
								<h4 class="no-margin font-bold"><i class="fa fa-shopping-basket" aria-hidden="true"></i> <?php echo $title; ?></h4>
								<hr />
							</div>
						</div>
						<div class="row">    
...
<div class="modal" id="payslip_template_modal" tabindex="-1" role="dialog">
	<div class="modal-dialog popup-with modal-dialog-with">
		<?php echo form_open_multipart('', array('id'=>'add_payslip_template')); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="col-md-12">
							<?php echo render_input('templates_name','templatesname','','text'); ?>
						</div>            
					</div>
				</div>
				<div class="row">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-info payslip_template_checked"><?php echo _l('submit'); ?></button>
			</div>
		</div>
		<?php echo form_close(); ?>
	</div>
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/payslip_templates/payslip_template_manage_js.php';?>
</body>
</html>
