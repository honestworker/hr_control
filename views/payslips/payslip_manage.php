					...
					<div class="panel-body">
						...
						<div class="row">    
							<div class="_buttons col-md-3">
								...
								<?php if (has_permission('hr_payslip', '', 'create') || is_admin()) { ?>
...
<div class="modal" id="payslip_template_modal" tabindex="-1" role="dialog">
	<div class="modal-dialog popup-with modal-dialog-with">
		<?php echo form_open_multipart('', array('id'=>'add_payslip')); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-info payslip_checked"><?php echo _l('submit'); ?></button>
...
<?php init_tail(); ?>
<?php require 'modules/hr_control/assets/js/payslips/payslip_manage_js.php';?>
</body>
</html>
