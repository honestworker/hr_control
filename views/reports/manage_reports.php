					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4 border-right">
								<h4 class="no-margin font-medium"><i class="fa fa-balance-scale" aria-hidden="true"></i> <?php echo _l('hrm_reports'); ?></h4>
								<hr class="hr-10" />
...
<?php init_tail(); ?>
<?php 
require('modules/hr_control/assets/js/reports/report_js.php');
?>
</body>
</html>
